...
/// <summary>
/// Provides a general implementation for the Capsium platform to run on Posix/Linux based devices
/// </summary>
public class LinuxPlatformOS : IPlatformOS
{
    ...
    /// <summary>
    /// The command line arguments provided when the Capsium application was launched
    /// </summary>
    ...
    /// <param name="args">The command line arguments provided when the Capsium application was launched</param>

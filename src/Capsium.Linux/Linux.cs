...
{
    /// <summary>
    /// Represents an instance of Capsium as a generic Linux process
    /// </summary>
    /// <typeparam name="TPinout"></typeparam>
    public class Linux<TPinout> : ICapsiumDevice
        where TPinout : IPinDefinitions, new()
    {
        ...
        /// <summary>
        /// Creates the Capsium on Linux infrastructure instance
        /// </summary>
        public Linux()
        {

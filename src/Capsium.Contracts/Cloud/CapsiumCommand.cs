...
/// <summary>
/// Represents a generic command that can be sent to a Meadow device through Capsium.Cloud.
/// </summary>
public class CapsiumCommand
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CapsiumCommand"/> class.
    /// </summary>
    ...
    public CapsiumCommand(string commandName, IReadOnlyDictionary<string, object>? arguments = null)
    {

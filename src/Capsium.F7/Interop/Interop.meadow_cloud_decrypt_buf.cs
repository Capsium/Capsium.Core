...
internal static partial class Interop
{
    public static partial class Nuttx
    {
        ...
        private static extern int Capsium_cloud_decrypt_buf(IntPtr encrypted_buf, int encrypted_len, IntPtr decrypted_buf);

        const int max_buf_size = 1024;

        public static byte[] CapsiumCloudDecryptRsa(byte[] buf)
        {
            ...
            try
            {
                ...
                int result_len = Capsium_cloud_decrypt_buf(encryptedBufferPtr, buf.Length, decryptedBufferPtr);

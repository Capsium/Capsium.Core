...
{
    /// <summary>
    /// A wrapped around the Capsium Generic Platform Driver
    /// </summary>
    /// <remarks>
    ...
    internal static class UPD
    {
        ...
        {
            var cr1 = UPD.GetRegister(STM32.Capsium_I2C1_BASE + STM32.I2C_CR1_OFFSET);
            var cr2 = UPD.GetRegister(STM32.Capsium_I2C1_BASE + STM32.I2C_CR2_OFFSET);
            var isr = UPD.GetRegister(STM32.Capsium_I2C1_BASE + STM32.I2C_ISR_OFFSET);
            var timing = UPD.GetRegister(STM32.Capsium_I2C1_BASE + STM32.I2C_TIMINGR_OFFSET);
            var timeout = UPD.GetRegister(STM32.Capsium_I2C1_BASE + STM32.I2C_TIMEOUTR_OFFSET);

...
namespace Capsium.Devices
{
    ...
    /// </summary>
    public abstract partial class F7CoreComputeBase : F7MicroBase, IF7CoreComputeCapsiumDevice
    {
        ...
        /// <summary>
        /// Creates an I2C bus instance for the default Capsium F7 pins (SCL/D08 and SDA/D07) and the requested bus speed
        /// </summary>
        ...
        protected override int GetSpiBusNumberForPins(IPin clock, IPin copi, IPin cipo)
        {
            ...
            // For the F7 Capsium it's enough to know and any attempt to use other pins will get caught by other sanity checks

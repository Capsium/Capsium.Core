...
namespace Capsium.Devices
{
    public abstract partial class F7MicroBase
    {
        ...
        /// <summary>
        /// Creates a SPI bus instance for the requested bus speed with the Capsium- default IPins for CLK, COPI and CIPO
        /// </summary>
        /// <returns>An instance of an IISpiBus</returns>
        public ISpiBus CreateSpiBus()
        {
            return CreateSpiBus(ICapsiumDevice.DefaultSpiBusSpeed);
        }
        ...
        {
            return CreateSpiBus(clock, copi, cipo, ICapsiumDevice.DefaultSpiBusSpeed);
        }

...
namespace Capsium.Devices
{
    ...
    public partial class F7GPIOManager : ICapsiumIOController
    {
        ...
        public virtual void Initialize(string[]? reservedPinList)
        {
            ...
            // these are the "unallocated" pins on the Capsium
        ...
        void ICapsiumIOController.SetDiscrete(IPin pin, bool value)
        {
        ...
        {
            // translate output type from Capsium to STM32
        ...
        {
            // translate resistor mode from Capsium to STM32 register bits

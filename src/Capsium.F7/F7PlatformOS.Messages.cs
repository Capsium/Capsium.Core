...
{
    /// <summary>
    /// The file name used for passing Platform OS messages to the Capsium stack
    /// </summary>
    public const string OsMessageFile = "Capsium.log";

    /// <summary>
    /// Retrieves any messages generated by the Capsium host OS prior to starting the Capsium stack
    /// </summary>
    /// <returns></returns>
    public IEnumerable<PlatformOsMessage>? GetStartupMessages()
    {
        ...
        // On the F7 platforms, Nuttx passes messages via a file named `Capsium.log` which is tilde-delimited
        // sample data
        /*

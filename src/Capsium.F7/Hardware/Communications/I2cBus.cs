...
namespace Capsium.Hardware
{
    ...
    public class I2cBus : II2cBus
    {
        ...
        private ICapsiumIOController IOController { get; }
        ...
        /// </summary>
        /// <param name="ioController">The Capsium IO Controller</param>
        ...
        public static I2cBus From(ICapsiumIOController ioController, IPin clock, IPin data, I2cBusSpeed busSpeed, ushort transactionTimeout = 100)
        {

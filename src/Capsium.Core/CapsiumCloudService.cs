...
/// <summary>
/// Encapsulates logic for communicating with Capsium.Cloud
/// </summary>
public class MeadowCloudService : ICapsiumCloudService
{
    /// <summary>
    /// Creates a MeadowCloudService
    /// </summary>
    /// <param name="settings">The settings used for interacting with the service</param>
    public MeadowCloudService(ICapsiumCloudSettings settings)
    {
        Settings = settings;
    }
    ...
    /// </summary>
    public ICapsiumCloudSettings Settings { get; protected set; }

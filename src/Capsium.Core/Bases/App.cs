            ...
            where D : class, ICapsiumDevice
    {
        ...
        public void InvokeOnMainThread(Action<object?> action, object? state = null)
        {
            switch (Device.Information.Platform)
            {
                ...
                case Hardware.CapsiumPlatform.F7FeatherV1:
                case Hardware.CapsiumPlatform.F7FeatherV2:
                case Hardware.CapsiumPlatform.F7CoreComputeV2:
                    action.Invoke(state);
                    break;
                default:

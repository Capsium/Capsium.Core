...
// NOTE: from KZU (released under MIT): https://gist.github.com/kzu/cfe3cb6e4fe3efea6d24
// When .NET Core gets an `ObservableDictionary`, we'll want to switch.
    ...
    INotifyCollectionChanged, INotifyPropertyChanged
{
    ...
    // todo: can't make public. don't understand the compiler error.

...
using Capsium.Units.Conversions;

namespace Capsium.Units
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Creates a new `ConcentrationInWater` object.
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        [Pure] public ConcentrationInWater Abs() { return new ConcentrationInWater(Math.Abs(this.Value)); }
